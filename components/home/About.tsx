...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-16 sm:py-20 md:py-28 bg-gradient-to-b from-white via-gray-50/50 to-white overflow-hidden scroll-mt-20 sm:scroll-mt-24 md:scroll-mt-28">
      {/* 배경 장식 */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
            <ScrollAnimation direction="right" delay={200}>
              <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-lg border-2 border-gray-100 hover:border-primary-200 hover:shadow-2xl transition-all duration-500">
            ...
            <ScrollAnimation direction="left" delay={400}>
              <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-lg border-2 border-primary-200 hover:border-primary-300 hover:shadow-2xl transition-all duration-500 overflow-hidden group relative">
                {/* 상단 장식 라인 */}
                  ...
                  {[
                    ...
                    >
                      <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-100 flex items-center justify-center mr-3 group-hover/item:bg-primary-600 group-hover/item:scale-110 transition-all duration-200 mt-0.5">
                        <svg className="w-4 h-4 text-primary-600 group-hover/item:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
