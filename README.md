...
- **프론트엔드 배포**: Vercel ✅ (배포 완료)
- **백엔드/데이터베이스**: Supabase ✅ (배포 완료)
...
프로젝트는 다음 플랫폼에 배포되어 있습니다:

- **프론트엔드**: Vercel (Next.js 서버리스 함수 포함)
- **데이터베이스**: Supabase (PostgreSQL)
- **파일 저장소**: Supabase Storage
...
배포 방법에 대한 자세한 내용은 `docs/VERCEL_DEPLOY.md`를 참고하세요.
